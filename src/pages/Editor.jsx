      ...
      <>
         <div className="container-editor">
            <div className="card-wrapper">
               <h1 className="title">Diseña tu baldosa</h1>
               <div className="instructions">
                  <p>
                     <strong>Instrucciones:</strong>
                     Selecciona un modelo de baldosa, elige un color de la paleta o del
                     selector personalizado, y haz clic en cualquier área blanca de la
                     baldosa para rellenarla con el color seleccionado.
                  </p>
               </div>
               <div className="design-area">
                  <div className="selection-menus">
                     <div className="baldosas-section">
                        <h6>BALDOSAS:</h6>
                        <p>
                           Seleccione el modelo de baldosa para crear su propio diseño de
                           suelo hidráulico.
                        </p>
                  ...
                  <div className="selection-menus">
                     <div className="editor-section">
                        <h6>EDITOR:</h6>
                        <p>
                           Seleccione el color para personalizar la baldosa elegida.
                           Pinche en la zona que desee colorear.
                        </p>
                     ...
                     <div className="color-display">
                        <h6>
                           El color elegido es: <span id="colorName">{colorName}</span>
                        </h6>
                     </div>
                  ...
                  <div className="selection-menus">
                     <div className="suelo-section">
                        <h6>SUELO:</h6>
                        <p>
                           A medida que vaya coloreando la baldosa el simulador se
                           rellenará automáticamente. Una vez haya finalizado el diseño de
                           su suelo puede comprobar el resultado en la vista 3D.
                        </p>
                     </div>
