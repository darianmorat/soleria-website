      ...
      <Section title="Preguntas frecuentes">
         <div className={styles.content}>
            <div className={styles.item}>
               ...
               <p>
                  Es una baldosa artesanal hecha con cemento pigmentado, sin cocción. Se
                  elabora una a una usando moldes metálicos y presión hidráulica. Su
            ...
            <div className={styles.item}>
               ...
               <ul>
                  <li>
                     Las baldosas <strong>hidráulicas</strong> no se hornean: se prensan y
                     secan al aire.
                  </li>
                  <li>
                  ...
                  <li>
                     La cerámica, en cambio, se fabrica en serie, se hornea y suele tener
               ...
               <div>
                  ...
                  <ul>
                     ...
                     <li>
                        ...
                        aproximadamente <strong>32 por metro cuadrado</strong> (el cálculo
                        puede variar según el diseño y la junta).
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  ...
                  <strong>30 días calendario</strong>, pero siempre se confirma al recibir
                  el pedido, según el volumen y la capacidad del taller.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Sí. Puedes elegir <strong>colores, formas, texturas y patrones</strong>.
                  Incluso podemos crear una baldosa desde cero, pensada para tu proyecto.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Escribirnos el <strong>mismo día</strong> que recibas el pedido y envias
                  fotos del daño. Pasado ese plazo, no podemos hacer reclamaciones. Deben
                  tener en cuenta que el transporte es externo y el material es frágil.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  ...
                  encontrar <strong>ligeras variaciones</strong> en el color, el espesor o
                  los bordes. Es parte de su carácter artesanal y único.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Sí, pero deben estar <strong>correctamente selladas</strong> para evitar
                  filtraciones o manchas.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Sí, enviamos a cualquier lugar de Colombia. Coordinamos el despacho con
                  transportadoras confiables y te informamos los costos y tiempos antes de
                  confirmar el pedido.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Sí, puedes armar composiciones mezclando diseños, colores y formas. Te
                  ayudamos a visualizar cómo quedarían juntos antes de confirmar tu
                  pedido.
               </p>
            </div>
            ...
            <div className={styles.item}>
               ...
               <p>
                  Sí. Si no sabes qué diseño elegir o quieres una propuesta personalizada,
                  podemos asesorarte para que el resultado se adapte a tu estilo, espacio
                  y necesidades.
               </p>
            </div>
